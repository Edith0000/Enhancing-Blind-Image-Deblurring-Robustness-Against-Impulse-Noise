...
kernel_folder = './Results/dif_noise_results/OID/kernel';
result_folder = './Results/dif_noise_results/OID/result';
true_result_folder = './Results/dif_noise_results_true/OID/result';
%clear_image_folder = './Data/dif_noise_data/image';
% 
%    % 获取清晰图像的图像列表
